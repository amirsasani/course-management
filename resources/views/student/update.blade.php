                        ...
                        <div class="tab-content">
                            ...
                            <form action="{{ route('student.update', $student) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fname" class="form-control rtl" id="fname" value="{{ old('student_no', $student->fname) }}">
                                </div>

                                <div class="form-group">
                                    <label for="lname" class="w-100 rtl">نام خانوادگی:</label>
                                    <input type="text" name="lname" class="form-control rtl" id="lname" value="{{ old('student_no', $student->lname) }}">
                                </div>

                                <div class="form-group">
                                    <label for="student_no" class="w-100 rtl">شماره دانشجویی:</label>
                                    <input type="text" name="student_no" class="form-control rtl" id="student_no" value="{{ old('student_no', $student->student_no) }}">
                                </div>
