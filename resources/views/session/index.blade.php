...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">"{{ $course->title }}" Course Sessions</div>

                    <div class="card-body">
                        <ul class="nav nav-tabs nav-justified">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('course.session.index', $course) }}">Course Sessions list</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('course.session.create') }}">new Course Session</a>
                            </li>
                        </ul>
